...
import { ObjectTypeDefinitionNode, InterfaceTypeExtensionNode, FieldDefinitionNode, StringValueNode, NameNode, DocumentNode, ObjectTypeExtensionNode, DirectiveNode, GraphQLNamedType, GraphQLError, GraphQLSchema, GraphQLObjectType, GraphQLField, SelectionNode, TypeDefinitionNode, InterfaceTypeDefinitionNode, TypeExtensionNode, ASTNode } from 'graphql';
...
export declare function findDirectivesOnTypeOrField(node: Maybe<ObjectTypeDefinitionNode | ObjectTypeExtensionNode | FieldDefinitionNode | InterfaceTypeDefinitionNode | InterfaceTypeExtensionNode>, directiveName: string): DirectiveNode[];
...
export declare function diffTypeNodes(firstNode: TypeDefinitionNode | TypeExtensionNode, secondNode: TypeDefinitionNode | TypeExtensionNode): {
    name: string[];
    kind: ("ScalarTypeDefinition" | "ObjectTypeDefinition" | "InterfaceTypeDefinition" | "UnionTypeDefinition" | "EnumTypeDefinition" | "InputObjectTypeDefinition" | "ScalarTypeExtension" | "ObjectTypeExtension" | "InterfaceTypeExtension" | "UnionTypeExtension" | "EnumTypeExtension" | "InputObjectTypeExtension")[];
    fields: {
